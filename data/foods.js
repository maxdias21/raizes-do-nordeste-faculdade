const foods = [
    ...
    {id: 2, name: "Tapioca de Carne Seca", description: "Carne seca com queijo coalho", price: 14.90, type: "tapioca"},
    {
        ...
        description: "Clássica com queijo derretido",
        price: 10.90,
        type: "tapioca"
    },
    ...
    {id: 10, name: "Tapioca Especial", description: "Frango, queijo e milho", price: 15.90, type: "tapioca", store: 1},
    ...
    {id: 13, name: "Cuscuz com Carne", description: "Cuscuz com carne moída", price: 11.90, type: "cuscuz", store: 2},
    {
        id: 14,
    ...
    {id: 25, name: "Brigadeiro", description: "Doce de chocolate", price: 3.50, type: "bolos e doces", store: 7},
    ...
    // BEBIDAS
    {id: 31, name: "Água", description: "Garrafa 500ml", price: 3.00, type: "bebidas", store: 7},
    {id: 32, name: "Refrigerante Lata", description: "350ml", price: 5.00, type: "bebidas"},
    {id: 33, name: "Suco Natural Laranja", description: "Feito na hora", price: 7.00, type: "bebidas", store: 5},
    ...
    {id: 36, name: "Vitamina de Banana", description: "Com leite", price: 8.50, type: "bebidas", store: 8},
    {id: 37, name: "Chá Gelado", description: "Limão", price: 5.50, type: "bebidas"},
    {id: 38, name: "Água de Coco", description: "Natural", price: 6.00, type: "bebidas", store: 8},
    {id: 39, name: "Guaraná Natural", description: "Energético", price: 6.50, type: "bebidas"},
    {id: 40, name: "Suco Detox", description: "Verde", price: 8.00, type: "bebidas", store: 2},

    // CAFÉS
    {id: 41, name: "Café Expresso", description: "Tradicional", price: 4.00, type: "cafés", store: 5},
    {id: 42, name: "Café com Leite", description: "Clássico", price: 5.00, type: "cafés"},
    {id: 43, name: "Capuccino", description: "Cremoso", price: 7.50, type: "cafés", store: 5},
    {id: 44, name: "Latte", description: "Leite vaporizado", price: 7.00, type: "cafés", store: 4},
    ...
    // COMBOS
    {id: 51, name: "Combo Café + Bolo", description: "Café + fatia de bolo", price: 10.90, type: "combos", store: 3},
    ...
    {id: 54, name: "Combo Doce + Café", description: "Doce + café", price: 9.90, type: "combos", store: 4},
    {id: 55, name: "Combo Completo", description: "Tapioca + suco + doce", price: 25.90, type: "combos", store: 4 },
    {id: 56, name: "Combo Fitness", description: "Suco detox + tapioca leve", price: 17.90, type: "combos"},
    {id: 57, name: "Combo Kids", description: "Suco + doce", price: 12.50, type: "combos", store: 3 },
    {id: 58, name: "Combo Café da Manhã", description: "Café + cuscuz + ovo", price: 16.90, type: "combos"},
    {id: 59, name: "Combo Tarde", description: "Café + bolo + doce", price: 14.90, type: "combos", store: 3},
    ...
    {id: 69, name: "Paçoca", description: "Doce de amendoim", price: 3.50, type: "sazonais", store: 3},
